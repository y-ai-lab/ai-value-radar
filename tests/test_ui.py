...
class StaticDashboardTests(unittest.TestCase):
    def test_dashboard_is_mobile_first_and_reads_public_state_only(self) -> None:
        ...
        self.assertIn("7日間の記録", html)
        self.assertIn("困ったときのチャット", html)
        ...
        self.assertIn("validation_status", javascript)
        self.assertIn("usage_status", javascript)
        self.assertIn("outcome_status", javascript)
        self.assertIn("投稿文を見る", javascript)
        self.assertIn("見るおすすめ度", javascript)
