...
def make_opportunity(raw: dict[str, Any], now_iso: str) -> Opportunity | None:
    ...
    return Opportunity(
        ...
        content_angle=clean_text(str(raw.get("content_angle") or ""), 500),
        reader_problem=clean_text(str(raw.get("reader_problem") or ""), 400),
        reader_action=clean_text(str(raw.get("reader_action") or ""), 400),
